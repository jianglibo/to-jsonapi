...
public abstract class Pager {
	...
	protected String removeOffsetParameter(String currentUrl, String stringTobeRemoved) {
		String first;
		if (stringTobeRemoved != null) {
			first = currentUrl.replace(stringTobeRemoved, "");
		} else {
			first = currentUrl;
		}
	...
	public abstract Map<String, String> calLinks(long totalResourceCount, String requestUrl);
